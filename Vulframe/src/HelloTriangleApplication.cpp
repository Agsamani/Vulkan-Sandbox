...
{
	if (glfwCreateWindowSurface(m_Instance, static_cast<GLFWwindow *>(window),
...
bool HelloTriangleApplication::extensionsSuported(VkPhysicalDevice device)
{
...
bool HelloTriangleApplication::isDeviceSuitable(VkPhysicalDevice device)
{
	...
	bool extSupported = extensionsSuported(device);
...
void HelloTriangleApplication::createLogicalDevice()
{
	...
	creatinfo.queueCreateInfoCount = static_cast<uint32_t>(queueCreateInfos.size());
	creatinfo.pQueueCreateInfos = queueCreateInfos.data();
	creatinfo.enabledExtensionCount = static_cast<uint32_t>(deviceExtentions.size());
	creatinfo.ppEnabledExtensionNames = deviceExtentions.data();
